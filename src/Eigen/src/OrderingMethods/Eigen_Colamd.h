    ...
    )
{
  ...
  unsigned int hash ;   /* hash value for supernode estimation */
  ...
  for (k = 0 ; k < n_col2 ; /* 'k' is incremented below */)
  {
	...
	*new_cp++ = row ;
	...
	k += Col [col].shared1.thickness ;
      ...
      {
	/* === Prepare for supercolumn estimation ==================== */

	COLAMD_DEBUG4 (("Preparing supercol estimation for Col: %d.\n", col)) ;

	/* save score so far */
	Col [col].shared2.score = cur_score ;

	/* add column to hash table, for supercolumn estimation */
	hash %= n_col + 1 ;
    ...
    /* === Supercolumn estimation ======================================== */

    COLAMD_DEBUG3 (("** Supercolumn estimation phase. **\n")) ;
    ...
    if (pivot_row_degree > 0)
    {
      ...
      /* during super-col estimation and mass elimination */
